...
@section('main')
	<div id="penggunaan">
		<h2>Edit Penggunaan Bahan Baku</h2>

		{!! Form::model($penggunaan, ['method' => 'PATCH', 'action' => ['PenggunaanController@update', $penggunaan->id]]) !!}
			@if (isset($penggunaan))
	{!! Form::hidden('id', $penggunaan->id) !!}
@endif
...
@endif
	...
	{!! Form::text('kode_guna', null, ['class' => 'form-control']) !!}
